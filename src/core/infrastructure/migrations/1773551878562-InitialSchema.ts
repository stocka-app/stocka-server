...
export class InitialSchema1773551878562 implements MigrationInterface {
    name = 'InitialSchema1773551878562'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "process_state" ("id" uuid NOT NULL, "process_name" character varying(100) NOT NULL, "correlation_id" character varying(255) NOT NULL, "status" character varying(20) NOT NULL DEFAULT 'started', "current_step" character varying(100) NOT NULL, "data" jsonb NOT NULL DEFAULT '{}', "error_message" text, "started_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "completed_at" TIMESTAMP WITH TIME ZONE, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_49696cec8b2f82b090c79b5f18a" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_4793e547cc4f53cf54c9b7bbd1"`);
