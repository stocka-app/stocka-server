...
export class InitialSchema1773967300457 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tenants"."tier_plans" ("tier" character varying(20) NOT NULL, "name" character varying(100) NOT NULL, "max_products" integer, "max_users" integer, "max_warehouses" integer DEFAULT '0', "policy_version" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_0813f6d3eedfb107638262c97ec" PRIMARY KEY ("tier"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tenants"."modules" ("id" SERIAL NOT NULL, "key" character varying(100) NOT NULL, "name" character varying(200) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_a57f2b3bd9ebb022212e634f601" UNIQUE ("key"), CONSTRAINT "PK_7dbefd488bd96c5bf31f0ce0c95" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tenants"."tier_module_policies" ("tier" character varying(20) NOT NULL, "module_id" integer NOT NULL, "enabled" boolean NOT NULL DEFAULT true, "config" jsonb, CONSTRAINT "PK_882c813e0e6675a6261f311b480" PRIMARY KEY ("tier", "module_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tenants"."catalog_actions" ("id" SERIAL NOT NULL, "module_id" integer NOT NULL, "key" character varying(100) NOT NULL, "name" character varying(200) NOT NULL, "action_type" character varying(50) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_a40fd4a57b8ecef7aa6373a7c17" UNIQUE ("key"), CONSTRAINT "PK_7179056fb9c1c945abb0b7ba465" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tenants"."tier_action_overrides" ("tier" character varying(20) NOT NULL, "action_id" integer NOT NULL, "enabled" boolean NOT NULL, "config" jsonb, CONSTRAINT "PK_ae9205636c13a60474abf8741a4" PRIMARY KEY ("tier", "action_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "identity"."social_sessions" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "archived_at" TIMESTAMP WITH TIME ZONE, "session_id" integer NOT NULL, "social_account_id" integer NOT NULL, "provider" character varying(20) NOT NULL, CONSTRAINT "UQ_6bec07f4de6dd88bf5d120620fc" UNIQUE ("uuid"), CONSTRAINT "UQ_045cff00bfa4267c978693cc82e" UNIQUE ("session_id"), CONSTRAINT "PK_cccb4ab82a7cdd7ec0b6efeed83" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."tier_module_policies" ADD CONSTRAINT "FK_fa76a4805611c6f268402b34912" FOREIGN KEY ("tier") REFERENCES "tenants"."tier_plans"("tier") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."tier_module_policies" ADD CONSTRAINT "FK_a952412d1cdc3d220fee8b03d34" FOREIGN KEY ("module_id") REFERENCES "tenants"."modules"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."catalog_actions" ADD CONSTRAINT "FK_1e4be5a3331df45396fb46c4842" FOREIGN KEY ("module_id") REFERENCES "tenants"."modules"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."tier_action_overrides" ADD CONSTRAINT "FK_3a4489f8b914fa4cba26f319b83" FOREIGN KEY ("tier") REFERENCES "tenants"."tier_plans"("tier") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."tier_action_overrides" ADD CONSTRAINT "FK_40f04fbc4405be1a0f0eff497c7" FOREIGN KEY ("action_id") REFERENCES "tenants"."catalog_actions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "identity"."social_accounts" ADD CONSTRAINT "FK_ae1e94e34fe10586fda04a99a94" FOREIGN KEY ("account_id") REFERENCES "identity"."accounts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."credential_accounts" ADD CONSTRAINT "FK_ee3e3e2575dc7b27974bb860877" FOREIGN KEY ("account_id") REFERENCES "identity"."accounts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."password_reset_tokens" ADD CONSTRAINT "FK_2a12933c8e4769b3d1cd2c8c45c" FOREIGN KEY ("credential_account_id") REFERENCES "identity"."credential_accounts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."email_verification_tokens" ADD CONSTRAINT "FK_d633df78199521854b2b9146146" FOREIGN KEY ("credential_account_id") REFERENCES "identity"."credential_accounts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."personal_profiles" ADD CONSTRAINT "FK_62a9258f166a0897dac03ba7939" FOREIGN KEY ("profile_id") REFERENCES "identity"."profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."commercial_profiles" ADD CONSTRAINT "FK_d86aad2568685f1e00dfbdf725f" FOREIGN KEY ("profile_id") REFERENCES "identity"."profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."social_profiles" ADD CONSTRAINT "FK_707a4cfedae4e94f5e46143ba13" FOREIGN KEY ("profile_id") REFERENCES "identity"."profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."credential_sessions" ADD CONSTRAINT "FK_6a946ad04ec3cc5074589b42201" FOREIGN KEY ("session_id") REFERENCES "identity"."sessions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."credential_sessions" ADD CONSTRAINT "FK_2c1b9ebe4027c6f543db4f6b3af" FOREIGN KEY ("credential_account_id") REFERENCES "identity"."credential_accounts"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."sessions" ADD CONSTRAINT "FK_da0cf19646ff5c6e3c0284468e5" FOREIGN KEY ("account_id") REFERENCES "identity"."accounts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."social_sessions" ADD CONSTRAINT "FK_045cff00bfa4267c978693cc82e" FOREIGN KEY ("session_id") REFERENCES "identity"."sessions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."social_sessions" ADD CONSTRAINT "FK_2f210ed328eaac49e362252f7f0" FOREIGN KEY ("social_account_id") REFERENCES "identity"."social_accounts"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "identity"."social_sessions" DROP CONSTRAINT "FK_2f210ed328eaac49e362252f7f0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."social_sessions" DROP CONSTRAINT "FK_045cff00bfa4267c978693cc82e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."sessions" DROP CONSTRAINT "FK_da0cf19646ff5c6e3c0284468e5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."credential_sessions" DROP CONSTRAINT "FK_2c1b9ebe4027c6f543db4f6b3af"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."credential_sessions" DROP CONSTRAINT "FK_6a946ad04ec3cc5074589b42201"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."social_profiles" DROP CONSTRAINT "FK_707a4cfedae4e94f5e46143ba13"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."commercial_profiles" DROP CONSTRAINT "FK_d86aad2568685f1e00dfbdf725f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."personal_profiles" DROP CONSTRAINT "FK_62a9258f166a0897dac03ba7939"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."email_verification_tokens" DROP CONSTRAINT "FK_d633df78199521854b2b9146146"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."password_reset_tokens" DROP CONSTRAINT "FK_2a12933c8e4769b3d1cd2c8c45c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."credential_accounts" DROP CONSTRAINT "FK_ee3e3e2575dc7b27974bb860877"`,
    );
    await queryRunner.query(
      `ALTER TABLE "identity"."social_accounts" DROP CONSTRAINT "FK_ae1e94e34fe10586fda04a99a94"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tenants"."tier_action_overrides" DROP CONSTRAINT "FK_40f04fbc4405be1a0f0eff497c7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."tier_action_overrides" DROP CONSTRAINT "FK_3a4489f8b914fa4cba26f319b83"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."catalog_actions" DROP CONSTRAINT "FK_1e4be5a3331df45396fb46c4842"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."tier_module_policies" DROP CONSTRAINT "FK_a952412d1cdc3d220fee8b03d34"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants"."tier_module_policies" DROP CONSTRAINT "FK_fa76a4805611c6f268402b34912"`,
    );
