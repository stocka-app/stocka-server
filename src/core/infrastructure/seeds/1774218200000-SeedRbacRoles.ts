  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      INSERT INTO "authz"."role_action_grants" ("role_key", "action_key") VALUES
        ...
        ('OWNER', 'STORAGE_DELETE'),   ('OWNER', 'STORAGE_FREEZE'),  ('OWNER', 'STORAGE_ARCHIVE'),
        ...
        ('PARTNER', 'STORAGE_DELETE'), ('PARTNER', 'STORAGE_FREEZE'),('PARTNER', 'STORAGE_ARCHIVE'),
        ...
        ('MANAGER', 'STORAGE_CREATE'), ('MANAGER', 'STORAGE_READ'),  ('MANAGER', 'STORAGE_UPDATE'),
        ('MANAGER', 'STORAGE_DELETE'), ('MANAGER', 'STORAGE_FREEZE'),('MANAGER', 'STORAGE_ARCHIVE'),
