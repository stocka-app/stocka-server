  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      INSERT INTO "authz"."role_action_grants" ("role_key", "action_key") VALUES
        ...
        ('OWNER', 'STORAGE_DELETE'),   ('OWNER', 'MEMBER_INVITE'),   ('OWNER', 'MEMBER_READ'),
        ...
        ('PARTNER', 'STORAGE_DELETE'), ('PARTNER', 'MEMBER_INVITE'), ('PARTNER', 'MEMBER_READ'),
        ...
        ('MANAGER', 'STORAGE_DELETE'), ('MANAGER', 'MEMBER_INVITE'), ('MANAGER', 'MEMBER_READ'),
