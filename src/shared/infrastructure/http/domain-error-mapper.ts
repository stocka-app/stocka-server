...
export const STATUS_MAP: Record<string, number> = {
  ...
  STORAGE_ARCHIVED_CANNOT_BE_UPDATED: HttpStatus.CONFLICT,
  STORAGE_ADDRESS_REQUIRED_FOR_WAREHOUSE: HttpStatus.BAD_REQUEST,
  STORAGE_TYPE_LOCKED_WHILE_FROZEN: HttpStatus.CONFLICT,
  STORAGE_TYPE_LOCKED_WHILE_ARCHIVED: HttpStatus.CONFLICT,
  STORAGE_ALREADY_FROZEN: HttpStatus.CONFLICT,
  STORAGE_NOT_FROZEN: HttpStatus.CONFLICT,
  STORAGE_NOT_ARCHIVED: HttpStatus.CONFLICT,
  STORAGE_ARCHIVED_CANNOT_BE_FROZEN: HttpStatus.CONFLICT,
