...
@Injectable()
@EventsHandler(StorageFrozenEvent)
export class StorageFrozenEventHandler implements IEventHandler<StorageFrozenEvent> {
  constructor(
  ...
  async handle(event: StorageFrozenEvent): Promise<void> {
