...
describe('PopupStateStore', () => {
  ...
  describe('Given a request with mode=popup in the query string', () => {
    describe('When store is called', () => {
      it('Then it produces a signed state string prefixed with "popup:"', (done) => {
  ...
  describe('Given a request without mode=popup in the query string', () => {
    describe('When store is called', () => {
      it('Then it produces a signed state string without the popup prefix', (done) => {
  ...
  describe('Given a valid state generated by store()', () => {
    describe('When verify is called', () => {
      it('Then ok is true', (done) => {
        const req = { query: {} } as unknown as Request;

        store.store(req, (_err, state) => {
          store.verify({} as unknown as Request, state, (err, ok) => {
            expect(err).toBeNull();
            expect(ok).toBe(true);
            done();
          });
